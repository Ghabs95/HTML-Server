package it.unifi.rc.httpserver.m5793664.handlers;
...
import it.unifi.rc.httpserver.m5793664.http_protocol.MyHTTPProtocolException;
import it.unifi.rc.httpserver.m5793664.http_protocol.MyHTTPReply;

/**
 * Class that extends {@link MyHTTPHandler1_0}.<p>
...
public class MyHTTPHandler1_1 extends MyHTTPHandler1_0 {
	/**
	 * Constructor that set up handler with a root and no host, using the superclass {@link MyHTTPHandler1_0} constructor.
	 * 
	 * @param root
	 */
	...
	/**
	 * Constructor that set up handler with both root and host, using the superclass {@link MyHTTPHandler1_0} constructor.
	 * 
	 * @param root
	 * @param host
	 */
	...
	/**
	 * @return a list of supported methods from {@link MyHTTPHandler1_1}.
	 */
	@Override
	...
	/**
	 * @return HTTP versions accepted by {@link MyHTTPHandler1_1}.
	 */
	@Override
