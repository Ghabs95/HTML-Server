 ...
 * Un istanza di questa classe � ottenibile mediante il metodo 
 * getHTTPServer( int port , int backlog , InetAddress address , HTTPHandler ... handlers)della classe MyHTTPFactory.
 * 
*/

package it.unifi.rc.httpserver.m5793664.server;
...
public class MyHTTPServer implements HTTPServer {
	...
	public void start() throws IOException {
		if (!isOnline) {
			...
			listener = new SingleThreadServer(serverSocket, chain, others); 
			listener.start();
