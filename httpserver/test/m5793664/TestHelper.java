package it.unifi.rc.httpserver.test.m5793664;
import java.io.File;
...
import it.unifi.rc.httpserver.m5793664.http_protocol.MyHTTPRequest;
...
public class TestHelper {
	...
	public HTTPReply processNullRequest0(String rootPath, String requestMessage) {
		HTTPHandler myHttpHandler1_0 = new MyHTTPHandler1_0(new File(rootPath));
	...
	public HTTPReply processRequestWithHandler1_1(String rootPath, String requestMessage) {
		HTTPHandler myHttpHandler1_1 = new MyHTTPHandler1_1(new File(rootPath));
		HTTPRequest myRequest = createRequestFromMessage(requestMessage);
	...
	public HTTPReply processRequestWithHandler1_0WithHostName(String rootPath, String hostName, String requestMessage) {
		return new MyHTTPHandler1_0(new File(rootPath), hostName).handle(createRequestFromMessage(requestMessage));
	}
	...
	public HTTPReply processRequestWithHandler1_1WithHostName(String rootPath, String hostName, String requestMessage) {
		return new MyHTTPHandler1_1(new File(rootPath), hostName).handle(createRequestFromMessage(requestMessage));
	}
